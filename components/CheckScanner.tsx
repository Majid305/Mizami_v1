...
export const CheckScanner = ({ onSave, onCancel, initialData }: any) => {
    ...
    if (!fileData && !isManualEntry) {
        return (
            <div className="flex flex-col items-center justify-center h-full p-6 space-y-8 bg-beurre dark:bg-lavande-deep transition-colors duration-500">
    ...
    if (analyzing) {
        return (
            <div className="h-full flex flex-col items-center justify-center bg-gradient-to-b from-beurre to-lavande-muted dark:from-lavande-deep dark:to-slate-950 text-gray-800 dark:text-white space-y-4">
    ...
    return (
        <div className="h-full overflow-y-auto pb-32 bg-beurre dark:bg-lavande-deep transition-colors duration-500">
